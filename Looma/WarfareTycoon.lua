...
LPH_JIT_MAX(function() -- Main Cheat
	...
	table.insert(connectionList, runService.RenderStepped:Connect(LPH_NO_VIRTUALIZE(function()
		if flags["knife_bot_kill_all"] then
		    for _, player in ipairs(players:GetPlayers()) do
		        if player ~= localplayer then
		            network:send("damage", player.Name, 9999, math.huge, "Knife", "Melee", "DefaultMelee", Head)
		        end
		    end
		end
...
LPH_NO_VIRTUALIZE(function() -- UI Creation
	...
	slientaim:Toggle({Name = "Enabled", Flag = "slient_aim_enabled"})
	slientaim:Toggle({Name = "Visible Check", Flag = "slient_aim_visible_check"})
	slientaim:List({Name = "Hit Priority", Flag = "slient_aim_target_priority", Options = {"Head", "HumanoidRootPart", "UpperTorso", "LowerTorso"}, Default = "Head"})
	slientaim:Slider({Name = "Hit Chance", Flag = "slient_aim_hit_chance", Suffix = "%", Default = 100, Min = 1, Max = 100, Decimals = 0.01})
	slientaim:Toggle({Name = "Use FOV", Flag = "slient_aim_use_fov"})
	...
	slientaim:Slider({Name = "FOV Radius", Flag = "slient_aim_fov_radius", Suffix = "px", Default = 100, Min = 0, Max = 250, Decimals = 0.1, Callback = getCallback("Slient Aim%%FOV Radius")})
	...
	gunmods:Toggle({Name = "No Recoil", Flag = "gun_mods_no_recoil"})
	gunmods:Toggle({Name = "No Spread", Flag = "gun_mods_no_spread"})
	gunmods:Toggle({Name = "No Drop", Flag = "gun_mods_no_drop"})
	gunmods:Toggle({Name = "No Sway", Flag = "gun_mods_no_sway"})
	gunmods:Toggle({Name = "Infinite Ammo", Flag = "gun_mods_inf_ammo"})
	gunmods:Toggle({Name = "Instant Bullet", Flag = "gun_mods_instant_bullet"})
	gunmods:Toggle({Name = "Instant Reload", Flag = "gun_mods_instant_reload"})
	gunmods:Toggle({Name = "Instant Aim", Flag = "gun_mods_instant_aim"})
	gunmods:Toggle({Name = "Unlock Firemode", Flag = "gun_mods_unlock_firemode"})
	
	ragebot:Toggle({Name = "Enabled", Flag = "rage_bot_enabled"})
	ragebot:Toggle({Name = "Rapid fire", Flag = "rage_bot_firerate"})
	ragebot:Slider({Name = "Firerate", Flag = "rage_bot_firerate_amount", Suffix = " RPS", Default = 2500, Min = 1, Max = 5000, Decimals = 0.1})
	ragebot:Toggle({Name = "Auto Shoot", Flag = "rage_bot_auto_shoot"}):Keybind({Flag = "auto_shoot_keybind"})
	ragebot:List({Name = "Auto Shoot Mode", Flag = "rage_bot_auto_shoot_mode", Options = {"Standard", "Manipulative", "Adaptive"}, Default = "Standard"})
	ragebot:Toggle({Name = "Whitelist Friendly Status", Flag = "rage_bot_friendly_check"})
	
	knifebot:Toggle({Name = "Kill All", Flag = "knife_bot_kill_all"})
	knifebot:Toggle({Name = "Whitelist Friendly Status", Flag = "knife_bot_friendly_check"})
	
	-- antiaim goe here
	
	enemyesp:Toggle({Name = "Enabled", Default = true, Flag = "enemy_esp_enabled", Callback = getCallback("Enemy ESP%%Enabled")})
	enemyesp:Toggle({Name = "Boxes", Flag = "enemy_esp_boxes", Callback = getCallback("Enemy ESP%%Boxes")}):Colorpicker({Name = "Box Color", Flag = "enemy_esp_box_color", Default = esp.Drawing.Boxes.Full.RGB, Callback = getCallback("Enemy ESP%%Boxes Color")})
	enemyesp:Toggle({Name = "Health Bar", Flag = "enemy_esp_health_bar", Callback = getCallback("Enemy ESP%%Health Bar")})
	enemyesp:Toggle({Name = "Health Bar Text", Flag = "enemy_esp_health_text", Callback = getCallback("Enemy ESP%%Health Text")}):Colorpicker({Name = "Health Text Color", Flag = "enemy_esp_health_text_color", Default = esp.Drawing.Healthbar.HealthTextRGB, Callback = getCallback("Enemy ESP%%Health Text Color")})
	enemyesp:Toggle({Name = "Name", Flag = "enemy_esp_name", Callback = getCallback("Enemy ESP%%Name")}):Colorpicker({Name = "Name Color", Flag = "enemy_esp_name_color", Default = esp.Drawing.Names.RGB, Callback = getCallback("Enemy ESP%%Name Color")})
	enemyesp:Toggle({Name = "Weapon", Flag = "enemy_esp_weapon", Callback = getCallback("Enemy ESP%%Weapon")}):Colorpicker({Name = "Weapon Color", Flag = "enemy_esp_weapon_color", Default = esp.Drawing.Weapons.WeaponTextRGB, Callback = getCallback("Enemy ESP%%Weapon Color")})
	enemyesp:Toggle({Name = "Distance", Flag = "enemy_esp_distance", Callback = getCallback("Enemy ESP%%Distance")}):Colorpicker({Name = "Distance Color", Flag = "enemy_esp_distance_color", Default = esp.Drawing.Distances.RGB, Callback = getCallback("Enemy ESP%%Distance Color")})
	enemyesp:List({Name = "Distance Position", Flag = "enemy_esp_distance_position", Options = {"Bottom", "Text"}, Default = "Bottom", Callback = getCallback("Enemy ESP%%Distance Position")})
	enemyesp:Toggle({Name = "Flags", Flag = "enemy_esp_flags", Callback = getCallback("Enemy ESP%%Flags")})
	enemyesp:Toggle({Name = "Chams", Flag = "enemy_esp_chams", Callback = getCallback("Enemy ESP%%Chams")})
	enemyesp:Toggle({Name = "Chams Thermal", Flag = "enemy_esp_chams_thermal", Default = esp.Drawing.Chams.Thermal, Callback = getCallback("Enemy ESP%%Chams Thermal")})
	enemyesp:Toggle({Name = "Chams Visible Check", Flag = "enemy_esp_chams_visible_check", Callback = getCallback("Enemy ESP%%Chams Visible Check")})
	enemyesp:Slider({Name = "Chams Fill Transparency", Flag = "enemy_esp_chams_fill_transparency", Suffix = "%", Default = esp.Drawing.Chams.Fill_Transparency, Min = 0, Max = 1, Decimals = 0.01, Callback = getCallback("Enemy ESP%%Chams Fill Transparency")})
	enemyesp:Slider({Name = "Chams Outline Transparency", Flag = "enemy_esp_chams_outline_transparency", Suffix = "%", Default = esp.Drawing.Chams.Outline_Transparency, Min = 0, Max = 1, Decimals = 0.01, Callback = getCallback("Enemy ESP%%Chams Outline Transparency")})
	
	espoptions:Colorpicker({Name = "Box Gradient", Flag = "enemy_esp_box_gradient", Default = Color3.fromRGB(119, 120, 255), Callback = getCallback("Enemy ESP%%Boxes Gradient")})
	espoptions:Colorpicker({Name = "Box Gradient Color 1", Flag = "enemy_esp_box_gradient_color_1", Default = Color3.fromRGB(119, 120, 255), Callback = getCallback("Enemy ESP%%Boxes Gradient Color 1")})
	espoptions:Colorpicker({Name = "Box Gradient Color 2", Flag = "enemy_esp_box_gradient_color_2", Default = Color3.fromRGB(0, 0, 0), Callback = getCallback("Enemy ESP%%Boxes Gradient Color 2")})
	espoptions:Colorpicker({Name = "Healthbar Gradient", Flag = "enemy_esp_healthbar_gradient", Default = Color3.fromRGB(200, 0, 0), Callback = getCallback("Enemy ESP%%Healthbar Gradient")})
	espoptions:Colorpicker({Name = "Healthbar Gradient Color 1", Flag = "enemy_esp_healthbar_gradient_color_1", Default = Color3.fromRGB(200, 0, 0), Callback = getCallback("Enemy ESP%%Healthbar Gradient Color 1")})
	espoptions:Colorpicker({Name = "Healthbar Gradient Color 2", Flag = "enemy_esp_healthbar_gradient_color_2", Default = Color3.fromRGB(60, 60, 125), Callback = getCallback("Enemy ESP%%Healthbar Gradient Color 2")})
	espoptions:Colorpicker({Name = "Weapons Gradient", Flag = "enemy_esp_weapons_gradient", Default = Color3.fromRGB(255, 255, 255), Callback = getCallback("Enemy ESP%%Weapons Gradient")})
	espoptions:Colorpicker({Name = "Weapons Gradient Color 1", Flag = "enemy_esp_weapons_gradient_color_1", Default = Color3.fromRGB(255, 255, 255), Callback = getCallback("Enemy ESP%%Weapons Gradient Color 1")})
	espoptions:Colorpicker({Name = "Weapons Gradient Color 2", Flag = "enemy_esp_weapons_gradient_color_2", Default = Color3.fromRGB(119, 120, 255), Callback = getCallback("Enemy ESP%%Weapons Gradient Color 2")})
	espoptions:Colorpicker({Name = "Chams Gradient", Flag = "enemy_esp_chams_gradient", Default = Color3.fromRGB(119, 120, 255), Callback = getCallback("Enemy ESP%%Chams Gradient")})
	espoptions:Colorpicker({Name = "Chams Gradient Fill Color", Flag = "enemy_esp_chams_gradient_fill_color", Default = Color3.fromRGB(119, 120, 255), Callback = getCallback("Enemy ESP%%Chams Gradient Fill Color")})
	espoptions:Colorpicker({Name = "Chams Gradient Outline Color", Flag = "enemy_esp_chams_gradient_outline_color", Default = Color3.fromRGB(0, 0, 0), Callback = getCallback("Enemy ESP%%Chams Gradient Outline Color")})
	...
	worldvisuals:Toggle({Name = "Ambient", Flag = "world_viusals_ambient", Callback = getCallback("World Visuals%%Ambient")}):Colorpicker({Name = "Ambient Color", Default = library.Accent, Callback = getCallback("World Visuals%%Ambient Color")})
	worldvisuals:Toggle({Name = "Bullet Tracers", Flag = "world_visuals_bullet_tracers"})
	worldvisuals:Colorpicker({Name = "Color Two", Flag = "world_visuals_bullet_color2", Default = library.Accent}):Colorpicker({Name = "Color One", Flag = "world_visuals_bullet_color1", Default = library.Accent})
	worldvisuals:Slider({Name = "Tracers Size", Flag = "world_visuals_bullet_size", Suffix = " Studs", Default = 2, Min = 0, Max = 5, Decimals = 0.01})
	worldvisuals:Toggle({Name = "Impact Points", Flag = "world_visuals_impact_points"}):Colorpicker({Name = "Impact Point Color", Flag = "world_visuals_impact_points_color", Default = library.Accent})
	worldvisuals:Slider({Name = "Impact Points Transparency", Flag = "world_visuals_impact_points_transparency", Suffix = "%", Default = 0.5, Min = 0, Max = 1, Decimals = 0.01})
